...
class ClassicCorrelation():
    ...
    '''This class computes correlation in sample using Pearson, Spearman and Kendall of a dataframe,
       provides a rolling correlation of the sample correlation of the given dataframe. 
       ...
       rolling_correlation()
           ...
           Computes a rolling window of 
           correlations. 
           Parameters : window (integer)
    ...
    def sample_correlation(self):
        ...
        ax = sns.heatmap(corr, mask = mask, annot = True, annot_kws={"size": 7})
    ...
    def rolling_correlation(self, window):
        ...
        self.corr_dataset.plot(subplots=True, figsize = (16,10), grid = True, sharex=False, title = 'Rolling Correlation')
...
class DynamicConditionalCorrelation():
    ...
    '''This code implements the GARCH(1,1) model of Dynamic Conditional Correlation, proposed by Engler.
